...
public class JeiChemicalComponent extends JeiComponent<ChemicalStack, RecipeRequirement<ChemicalComponent,
    RequirementChemical, BasicChemicalTank>> {
  public JeiChemicalComponent(RecipeRequirement<ChemicalComponent, RequirementChemical, BasicChemicalTank> requirement) {
