...
public class RequirementChemicalPerTick implements IRequirement<ChemicalComponent> {
  ...
  public RequirementChemicalPerTick(IOType ioType, SingleChemicalIngredient chemical, long amount, PositionedRequirement position) {
    this.mode = ioType;
  ...
  public boolean test(ChemicalComponent component, ICraftingContext context) {
    ...
    long amount = (int) context.getPerTickIntegerModifiedValue(this.amount, this);
  ...
  private CraftingResult processInput(ChemicalComponent component, ICraftingContext context) {
    long amount = context.getPerTickIntegerModifiedValue(this.amount, this);
