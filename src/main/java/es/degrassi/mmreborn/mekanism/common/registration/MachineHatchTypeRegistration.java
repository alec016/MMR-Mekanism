...
public class MachineHatchTypeRegistration {
  ...
  public static final Supplier<MachineHatchType> HEAT_INPUT_HATCH =
      MACHINE_COMPONENTS.register(rootLC("HEAT_INPUT_HATCH".toLowerCase(Locale.ENGLISH)), MachineHatchType::create);

  public static final Supplier<MachineHatchType> HEAT_OUTPUT_HATCH =
      MACHINE_COMPONENTS.register(rootLC("HEAT_OUTPUT_HATCH".toLowerCase(Locale.ENGLISH)), MachineHatchType::create);
