...
public class RequirementHeat implements IRequirement<HeatComponent, BasicHeatCapacitor> {
  ...
  @Override
  public RequirementType<RequirementHeat, HeatComponent, BasicHeatCapacitor> getType() {
