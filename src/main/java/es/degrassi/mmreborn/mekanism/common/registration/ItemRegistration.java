...
public class ItemRegistration {
  ...
  public static final DeferredItem<HeatVentItem> HEAT_INPUT_VENT = ITEMS.register("heat_input_vent",
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT.get()));

  public static final DeferredItem<HeatVentItem> HEAT_OUTPUT_VENT = ITEMS.register("heat_output_vent",
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT.get()));
