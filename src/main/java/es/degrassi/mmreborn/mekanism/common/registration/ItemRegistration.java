...
public class ItemRegistration {
  ...
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_TINY = ITEMS.register("heat_input_vent_" + HeatVentSize.TINY.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_TINY.get(), HeatVentSize.TINY));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_SMALL = ITEMS.register("heat_input_vent_" + HeatVentSize.SMALL.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_SMALL.get(), HeatVentSize.SMALL));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_NORMAL = ITEMS.register("heat_input_vent_" + HeatVentSize.NORMAL.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_NORMAL.get(), HeatVentSize.NORMAL));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_REINFORCED = ITEMS.register("heat_input_vent_" + HeatVentSize.REINFORCED.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_REINFORCED.get(), HeatVentSize.REINFORCED));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_BIG = ITEMS.register("heat_input_vent_" + HeatVentSize.BIG.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_BIG.get(), HeatVentSize.BIG));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_HUGE = ITEMS.register("heat_input_vent_" + HeatVentSize.HUGE.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_HUGE.get(), HeatVentSize.HUGE));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_LUDICROUS = ITEMS.register("heat_input_vent_" + HeatVentSize.LUDICROUS.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_LUDICROUS.get(), HeatVentSize.LUDICROUS));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_INPUT_VENT_VACUUM = ITEMS.register("heat_input_vent_" + HeatVentSize.VACUUM.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_INPUT_VENT_VACUUM.get(), HeatVentSize.VACUUM));

  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_TINY = ITEMS.register("heat_output_vent_" + HeatVentSize.TINY.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_TINY.get(), HeatVentSize.TINY));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_SMALL = ITEMS.register("heat_output_vent_" + HeatVentSize.SMALL.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_SMALL.get(), HeatVentSize.SMALL));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_NORMAL = ITEMS.register("heat_output_vent_" + HeatVentSize.NORMAL.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_NORMAL.get(), HeatVentSize.NORMAL));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_REINFORCED = ITEMS.register("heat_output_vent_" + HeatVentSize.REINFORCED.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_REINFORCED.get(), HeatVentSize.REINFORCED));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_BIG = ITEMS.register("heat_output_vent_" + HeatVentSize.BIG.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_BIG.get(), HeatVentSize.BIG));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_HUGE = ITEMS.register("heat_output_vent_" + HeatVentSize.HUGE.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_HUGE.get(), HeatVentSize.HUGE));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_LUDICROUS = ITEMS.register("heat_output_vent_" + HeatVentSize.LUDICROUS.getSerializedName(),
      () -> new HeatVentItem(BlockRegistration.HEAT_OUTPUT_VENT_LUDICROUS.get(), HeatVentSize.LUDICROUS));
  public static final DeferredHolder<Item, HeatVentItem> HEAT_OUTPUT_VENT_VACUUM = ITEMS.register("heat_output_vent_" + HeatVentSize.VACUUM.getSerializedName(),
