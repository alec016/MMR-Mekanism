...
public class HeatInputVentEntity extends HeatVentEntity implements IAutoInputEntity {
  public HeatInputVentEntity(BlockPos pos, BlockState state) {
    super(EntityRegistration.HEAT_INPUT_VENT.get(), pos, state, IOType.INPUT);
  }
