...
public class JeiHeatComponent extends JeiComponent<Double, RecipeRequirement<HeatComponent, RequirementHeat, BasicHeatCapacitor>> {
  private static final ResourceLocation RATE_BAR = ModularMachineryRebornMekanism.rl("textures/gui/vertical_rate.png");
  public JeiHeatComponent(RecipeRequirement<HeatComponent, RequirementHeat, BasicHeatCapacitor> requirement) {
